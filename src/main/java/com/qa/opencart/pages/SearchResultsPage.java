...
public class SearchResultsPage {
	...
	private final By searchResults = By.cssSelector("div.product-thumb");//macbook,macbookAir,macbookPro
	private final By resultsHeader = By.cssSelector("div#content h1");//search-macbook
