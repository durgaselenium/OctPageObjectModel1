...
public class AppConstants {
	...
	public static final String LOGIN_PAGE_FRANCTION_URL = "route=account/login";
	...
	public static final String LOGIN_INVALID_CRED_MESSG = "Warning: No match for E-Mail Address and/or Password.";
