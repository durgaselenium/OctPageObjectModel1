...
String succesMesg = eleUtil.waitForElementVisible(successMesg, AppConstants.DEFAULT_MEDIUM_WAIT).getText();
System.out.println(succesMesg);

if(succesMesg.contains(AppConstants.USER_REGISTER_SUCCESS_MESSG)) {
