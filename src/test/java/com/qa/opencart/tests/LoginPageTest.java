...
@Epic("EP-100: Design the Openn Cart App Login Page")
@Feature("F-101: design open cart login feature")
@Story("US-50: develop login core features: title,url, user is abe to login")
public class LoginPageTest extends BaseTest {

@Description("login page title test...")
@Link("")
@Owner("Durga Automation Labs")
...
public void loginPageURLTest() {
 ...
 Assert.assertTrue(actURL.contains(AppConstants.LOGIN_PAGE_FRANCTION_URL));
}
